...
if __name__ == '__main__':
    # This imports the classes for both of your experiments
    from MerCBO.experiments.test_functions.transformer_perplexity import TransformerPerplexity
    from MerCBO.experiments.test_functions.EncoderBO import EncoderBO
    ...
    if objective_ == 'transformer':
        # This runs your FIRST experiment (optimizing 10 fixed patterns)
        print("[main.py] INFO: Initializing 'transformer' objective (10 fixed patterns).")
        kwag_['objective'] = TransformerPerplexity()
        MerCBO(**kwag_)
        sys.exit(0)
    elif objective_ == 'nas_encoder':
        # This runs your NEW experiment (full neural architecture search)
        print("[main.py] INFO: Initializing 'nas_encoder' objective (full architecture search).")
        kwag_['objective'] = EncoderBO()
        MerCBO(**kwag_)
        sys.exit(0)
    # --- End of custom logic ---
    ...
    # This loop is for the original MerCBO benchmark objectives ('ising', 'labs')
